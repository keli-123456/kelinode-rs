...
pub const PATH_V2_SERVER_HANDSHAKE: &str = "/api/v2/server/handshake";
pub const PATH_V2_SERVER_REPORT: &str = "/api/v2/server/report";
...
mod tests {
    ...
    fn endpoint_paths_match_go_contract() {
        ...
        assert_eq!(PATH_V2_SERVER_HANDSHAKE, "/api/v2/server/handshake");
        assert_eq!(PATH_V2_SERVER_REPORT, "/api/v2/server/report");
