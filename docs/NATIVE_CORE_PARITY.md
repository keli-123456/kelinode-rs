...
| DNS route | Partial | Renders default UDP DNS servers and panel DNS routes into native core DNS config. Native core executes domain-scoped UDP DNS resolution; DoH/DoT/TCP DNS remain Xray-only. |
